...
async getBooksFromApi(bookName)
{
  ...
  {
    var books= await BookSearch.searchbook(bookName,'AIzaSyB76zv_QkJSU5RQEW75KOInpRC1w9nZenI')
...
renderItem=({item,i})=>{
  ...
  return(
    <TouchableHighlight style={{alignItems:'center',padding:10,width:'90%',backgroundColor:'#DDDDDD'}}
    activeOpacity={0.6}
